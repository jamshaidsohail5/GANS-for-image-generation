...
for epoch in range(25):
    for i,data in enumerate(dataloader, 0):
        ...
        # Step 2 Updating the weights of the neural network of Generator
        netG.zero_grad()
        target = Variable(torch.ones(input.size()[0]))
        output = netD(fake)
        ...
        # Step 3 Printing the losses and saving the real images and the fake images every 100 steps
